...
setup(
    ...
    maintainer_email='swathikarthikeyan@utexas.edu',
    ...
    entry_points={
        'console_scripts': [
            ...
            'simulate_bayes_search = bayes_scavenger.simulation:main',
            'evaluate_bayes_search = bayes_scavenger.evaluation:main',
